...
public interface BookControllerDoc {
    ...
    ResponseEntity<BookResponsePageDTO> getBooksInLibraryByStatus(@PathVariable long id,
    ...
    public ResponseEntity<BookResponseDTO> updatePagesReadInBook(@RequestBody PagesUpdateRequestDTO requestDTO, JwtAuthenticationToken token);
    ...
    @PostMapping("/finish")
    public ResponseEntity<BookResponseDTO> finishBook(@RequestBody FinishBookRequestDTO requestDTO, JwtAuthenticationToken token);
    ...
    @GetMapping("/{id}")
    public ResponseEntity<FullBookResponseDTO> getBookInformation(@PathVariable long id, JwtAuthenticationToken token);
    ...
    public ResponseEntity<BookResponseDTO> changeBookFromLibrary(@RequestBody ChangeLibRequestDTO requestDTO, JwtAuthenticationToken token);
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteBook(@PathVariable long id, JwtAuthenticationToken token);
}
